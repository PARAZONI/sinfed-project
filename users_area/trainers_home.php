...
// Récupérer les informations de l'utilisateur (formateur)
...
<div class="header">
    ...
    <p>Gérez vos cours, suivez vos élèves et créez de nouveaux cours.</p>
</div>

<!-- Main content -->
<div class="container mt-5">
    <div class="row">
        <!-- Colonne des informations du formateur -->
        <div class="col-md-4">
            <div class="card">
        ...
        <!-- Colonne des cours créés par le formateur -->
        <div class="col-md-8">
            <h3>Mes Cours</h3>
            ...
            <?php else : ?>
                <p class="alert alert-warning">Vous n'avez créé aucun cours pour le moment. Créez un cours dès maintenant !</p>
            <?php endif; ?>

            <!-- Ajouter un nouveau cours -->
            <div class="mt-4 mb-5">
                <h3>Créer un nouveau cours</h3>
                <a href="create_course.php" class="btn btn-primary">Créer un cours</a>
                <a href="gestion_categories.php" class="btn btn-primary">Voir la categorie</a>
